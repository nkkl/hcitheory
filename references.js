$(document).ready(function() {
	...
	var references = {
		...
		'bowker': 'Bowker, Geoffrey C., and Susan Leigh Star. "How things (actor-net) work: Classification, magic and the ubiquity of standards." <em>Philosophia</em> 25.3-4 (1996): 195-220',
		...
		'desouza2': 'de Souza, C. S. (2013): Semiotics. In: Soegaard, Mads and Dam, Rikke Friis (eds.). "The Encyclopedia of Human-Computer Interaction, 2nd Ed.". Aarhus, Denmark: The Interaction Design Foundation. Available online at <a href="http://www.interaction-design.org/encyclopedia/semiotics_and_human-computer_interaction.html"> http://www.interaction-design.org/encyclopedia/semiotics_and_human-computer_interaction.html</a>',
		...
		'halverson': 'Halverson, C. A. (1994). <em>Distributed cognition as a theoretical framework for HCI: Don&apos;t throw the baby out with the bathwater—The importance of the cursor in air traffic control</em>. San Diego: University of California, San Diego, Department of Cognitive Science.',
		...
		'kaptelinin3': 'Kaptelinin, V., Nardi, B. A., &amp; Macaulay, C. (July 01, 1999). Methods &amp; tools: The activity checklist: a tool for representing the “space” of context. <em>Interactions, 6</em>, 4, 27-39.',
